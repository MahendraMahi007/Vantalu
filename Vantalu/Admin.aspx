    ...
    <form id="form1" runat="server">
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1">
            <EditItemTemplate>
                ...
                <br />
                Description:
                <asp:TextBox Rows="10" Columns="10" TextMode="MultiLine" ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>' />
                <br />
                Title:
                <asp:TextBox ID="TitleTextBox" runat="server" Text='<%# Bind("Title") %>' />
                <br />
                Keywords:
                <asp:TextBox TextMode="MultiLine" ID="KeywordsTextBox" runat="server" Text='<%# Bind("Keywords") %>' />
                <br />
                Video:
                <asp:TextBox TextMode="MultiLine" ID="VideoTextBox" runat="server" Text='<%# Bind("Video") %>' />
                <br />
            ...
            <InsertItemTemplate>
                ...
                <br />
                Description:
                <asp:TextBox TextMode="MultiLine" ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>' />
                <br />
                Title:
                <asp:TextBox ID="TitleTextBox" runat="server" Text='<%# Bind("Title") %>' />
                <br />
